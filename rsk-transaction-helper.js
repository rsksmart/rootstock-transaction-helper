...
class RskTransactionHelper{
    ...
    createWeb3Client(){
        try {
            this.web3Client = new Web3(new Web3.providers.HttpProvider(this.rskConfig.hostUrl));
        }
        catch (err) {
    ...
    async signAndSendTransactionCheckingBalance(call, senderAddress, senderPrivateKey, destinationAddress){
        ...
        return this.signAndSendTransaction(
            ...
            checkBalance.estimatedGas.mul(this.rskClient.utils.toBN("110")).div(this.rskClient.utils.toBN("100")), // Add a 10% increment
            destinationAddress, 
            call.encodeABI()
        );
    }
